...
<html>
<head>
	<title>TasteHub Restaurant | Contact Us</title>
...
<!-- log in -->
	...
	<div class="contact py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			<!-- tittle heading -->
			<h3 class="tittle-w3l border-top border-bottom text-center mb-lg-5 mb-sm-4 mb-3">
				<span>C</span>ontact
				<span>U</span>s
			</h3>
			<!-- //tittle heading -->
			<div class="row contact-grids agile-1 mb-5">
				<div class="col-sm-4 contact-grid agileinfo-6 mt-sm-0 mt-2">
					<div class="contact-grid1 text-center">
						...
						<p style="font-weight: bold;color:black;">TasteHub Restaurant
							<label style="font-weight: bold;color:black;">Opposite ABC Square Mall, Edappally, Kochi, Kerala</label>
						</p>
					</div>
				</div>
				<div class="col-sm-4 contact-grid agileinfo-6 my-sm-0 my-4">
					<div class="contact-grid1 text-center">
						...
						<p style="font-weight: bold;color:black;"><a style="font-weight: bold;color:black;" href="tel:+91123456789">+(91) 123 456 789</a>
...
<!-- 							<label>+(91) 121 122 000</label> -->
				...
				<div class="col-sm-4 contact-grid agileinfo-6">
					<div class="contact-grid1 text-center">
						...
						<p>
							<a style="font-weight: bold;color:black;" href="mailto:hello@tastehub.com">hello@tastehub.com</a>
						</p>
					</div>
				</div>
			</div>
			...
			<form id="form" method="post">
				<div class="contact-grids1 w3agile-6">
					...
					<center><div class="right-w3l col-md-6">
