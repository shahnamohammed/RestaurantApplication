...
<html>
<head>
	<title>TasteHub Restaurant | Add Product </title>
	...
	<div class="services-breadcrumb">
		<div class="agile_inner_breadcrumb">
			<div class="container">
				<ul class="w3_short">
					<li>
						<a href="${pageContext.request.contextPath}/home">Admin Dashboard</a>
						<i>|</i>
					</li>
					<li>Add Item</li>
				</ul>
				...
				<div class="contact-grids1 w3agile-6">
					<div class="row">
						<div class="col-md-6 col-sm-6 contact-form1 form-group">
							<label class="col-form-label">Name of Item</label>
						...
						<center><div class="right-w3l col-md-6"><br><br><br>
							<input type="button" style="background-color: #80080;" id="submit" class="btn btn-primary form-control" value="Add Item to Menu">
						</div></center>
				</div>
			</form>
			<!-- //form -->
