...
<html>
<head>
	<title>TasteHub Restaurant | Menu </title>
				...
				<div class="agileinfo-ads-display col-lg-12">
					<div class="wrapper">
						...
						<div class="px-sm-4 px-3 py-sm-5 py-3 mb-4">
							<c:if test="${not empty products}"><h3 class="heading-tittle text-center font-italic">
							<span>O</span>ur
							<span>M</span>enu
							</h3></c:if>
							<div class="row">
								...
								<div class="col-md-3 product-men mt-5" style="width:100%;">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="${pageContext.request.contextPath}${product.image}" class="img-fluid2">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro" style="margin-top:-55px;">
													<a href="${pageContext.request.contextPath}/product/productdetails?code=${product.code}" class="link-product-add-cart">View Details</a>
												</div>
											</div>
										</div>
...
<div class="row">
      ...
      -->
					...
					<c:otherwise>
						<c:if test="${empty products}"><div class="col-12 text-center"><h1>FOOD IS BEING PREPARED..</h1></div></c:if>
				</c:otherwise>
				</c:choose>
					</div>
				</div>
