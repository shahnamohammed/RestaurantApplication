...
<c:if test="${empty email}">
	...
	<title>TasteHub Restaurant  | My Cart</title>
...
<button type="button" class="btn btn-primary">
  Total Savings: <span class="badge badge-light">&#x20b9;${total_saving}</span>
	...
	<!------------------------------------------- Billing section --------------------->	
			...
			<h5 class="mb-sm-4 mb-3 text-danger" style="font-weight: bold;">Note: Only Cash on Delivery available.</h5>
								<div class="first-row">
...
<!-- 									<input type="hidden" name="paymentMode" /> -->
				...
				<div class="col-sm-12 text-left">
         			<input type="submit" id="submit" class="btn btn-success btn-md center-block" value="Place Order" style="width: 100px;" />
...
<!-- 	<div class="col-sm-12 text-left">
         			<input type="submit" id="submit" class="btn btn-success btn-md center-block" value="Place Order" style="width: 100px;" />
                 	&emsp;
                 	<a class="btn btn-primary btn-md center-block" href="${pageContext.request.contextPath}/product/all">Back to Menu</a>
