	...
	<div class="navbar-inner">
		<div class="container">
			...
			<h1 class="text-left mr-12">
				<a href="${pageContext.request.contextPath}/admin/home" class="font-weight-bold font-italic" style="font-size: 22px;color:#800080;">
					<img src="${pageContext.request.contextPath}/images/Capture.PNG" class="img-fluid">&nbsp;TasteHub Restaurant
				</a>
			</h1>
					...
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
						...
						<li class="nav-item dropdown mr-lg-2 mb-lg-0 mb-2">
							...
							<div class="dropdown-menu">
								<a class="dropdown-item" href="${pageContext.request.contextPath}/admin/product/view">View Menu</a>
								<a class="dropdown-item" href="${pageContext.request.contextPath}/admin/product/add">Add Item</a>
							</div>
						</li>
						<li class="nav-item dropdown mr-lg-2 mb-lg-0 mb-2">
							<a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
