				...
				<div class="col-md-3 logo_agile mb-4">
					<h1 class="text-center">
						<a href="${pageContext.request.contextPath}/home" class="font-weight-bold font-italic" style="font-size: 22px;">
							<img src="${pageContext.request.contextPath}/images/Capture.PNG" class="img-fluid2">&nbsp;TasteHub Restaurant
						</a>
					</h1>
				</div>		
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
						...
						<li class="nav-item mr-lg-2 mb-lg-0 mb-2">
							<a class="nav-link" href="index#chefs">Our Chefs</a>
						</li>	
						<li class="nav-item mr-lg-2 mb-lg-0 mb-2">
						...
						<li class="nav-item">
						<li class="nav-item mr-lg-2 mb-lg-0 mb-2">
							<a class="nav-link" href="${pageContext.request.contextPath}/product/all">Menu</a>
						</li>
