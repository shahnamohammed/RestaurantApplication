...
<meta http-equiv = "refresh" content = "2; url=http://localhost:8080/orders/my-orders"/>
</head>
<body>
		...
		<div class="container py-xl-4 py-lg-2">
			...
			<c:if test="${not empty success}">
				...
				<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
					<span>O</span>rder Placed Successfully!
				</h3>
				<h4 class="text-center">
					Thank you for your order.
					<!-- 	<a href="${pageContext.request.contextPath}/orders/getPdf">
	click</a> here to send bill to your email.		 -->

				</h4>
				<center>
					<div>
						<img src="/images/preparing.png" class="img-fluid2">
			...
			<c:if test="${not empty pdf}">
				<h4 class="text-center">
					Email has been sent.<a
						href="${pageContext.request.contextPath}/orders/my-orders">
						click</a> here to check your orders.
				</h4>
			</c:if>
			<c:if test="${not empty error_pdf}">
				<h4 class="text-center">Oops! Something Went Wrong While
					Sending Email.</h4>
			</c:if>
